...
def write_scoreAllPermutations(outputbook_loc,nameSheet_loc,numParticipants_loc,deelnemers_loc, numQuestion_loc,content_loc,content_colNrs_loc,totalScore_loc,totalScoreDifferentPermutations_loc,columnSeries_loc):
    ...
    sheetC.write(rowCounter,columnCounter,"totale score aangeduide serie ",style=easyxf(style_header))
    rowCounter+=1
...
def write_overallStatistics(outputbook_loc,nameSheet_loc,totalScore_loc,averageScore_loc,medianScore_loc,percentagePass_loc,maxTotalScore_loc):
    ...
    sheetC.write(rowCounter,columnCounter,"aantal deelnemers",style=easyxf(style_header))
    columnCounter+=1  
    sheetC.write(rowCounter,columnCounter,numParticipants_loc)
    rowCounter+=1
    
    columnCounter = 0
    sheetC.write(rowCounter,columnCounter,"gemiddelde score ",style=easyxf(style_header))
    columnCounter+=1  
    sheetC.write(rowCounter,columnCounter,round(averageScore_loc,2))
    rowCounter+=1
    
    columnCounter = 0
    sheetC.write(rowCounter,columnCounter,"mediaan ",style=easyxf(style_header))
    columnCounter+=1  
    sheetC.write(rowCounter,columnCounter,round(medianScore_loc,2))
    rowCounter+=1
    
    columnCounter = 0
    sheetC.write(rowCounter,columnCounter,"% geslaagd ",style=easyxf(style_header))
    columnCounter+=1 
...
def write_percentageImpossibleQuestionsUML(outputbook_loc,nameSheet_loc,numQuestions_loc,correctAnswers_loc,alternatives_loc,numOnmogelijkQuestionsAlternativesUpper_loc,numOnmogelijkQuestionsAlternativesMiddle_loc,numOnmogelijkQuestionsAlternativesLower_loc,numUpper_loc,numMiddle_loc,numLower_loc):
    ...
    for alternative in alternatives_loc:
        ...
        sheetC.write(rowCounter+1,columnCounter+2,"lower",style=easyxf(style_header) )   
        columnCounter+=3   
    rowCounter+=2
        ...
        for alternative in alternatives_loc:
            if alternative == correctAnswer:
                ...
                if ( (numOnmogelijkQuestionsAlternativesUpper_loc[counter]/numUpper_loc > numOnmogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc) ):
                    ...
                    sheetC.write(rowCounter,columnCounter+2,round(numOnmogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc,2),style=easyxf(style_correctAnswer+style_specialAttention))
                else:
                    #TODO make 20 parameter
                    ...
                    sheetC.write(rowCounter,columnCounter+2,round(numOnmogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc,2),style=easyxf(style_correctAnswer))                
            else:
                ...
                if (numOnmogelijkQuestionsAlternativesUpper_loc[counter]/numUpper_loc < numOnmogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc):
                    ...
                    sheetC.write(rowCounter,columnCounter+2,round(numOnmogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc,2),style=easyxf(style_specialAttention))
                else:
        ...
        for alternative in alternatives_loc:
            if alternative == correctAnswer:
                ...
                if (numMogelijkQuestionsAlternativesUpper_loc[counter]/numUpper_loc < numMogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc):
                    ...
                    sheetC.write(rowCounter,columnCounter+2,round(numMogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc,2),style=easyxf(style_correctAnswer+style_specialAttention))
                else:
                    ...
                    sheetC.write(rowCounter,columnCounter+2,round(numMogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc,2),style=easyxf(style_correctAnswer))                
            else:
                ...
                if (numMogelijkQuestionsAlternativesUpper_loc[counter]/numUpper_loc > numMogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc):
                    ...
                    sheetC.write(rowCounter,columnCounter+2,round(numMogelijkQuestionsAlternativesLower_loc[counter]/numLower_loc,2),style=easyxf(style_specialAttention))
                else:
        ...
        for alternative in alternatives_loc:
            if alternative == correctAnswer:
                ...
                if (numOnmogelijkQuestionsAlternativesUpper_loc[counter] > numOnmogelijkQuestionsAlternativesLower_loc[counter]):
                    ...
                    sheetC.write(rowCounter,columnCounter+2,numOnmogelijkQuestionsAlternativesLower_loc[counter],style=easyxf(style_correctAnswer+style_specialAttention))
                else:
                    ...
                    sheetC.write(rowCounter,columnCounter+2,numOnmogelijkQuestionsAlternativesLower_loc[counter],style=easyxf(style_correctAnswer))                
            else:
                ...
                if (numOnmogelijkQuestionsAlternativesUpper_loc[counter] < numOnmogelijkQuestionsAlternativesLower_loc[counter]):
                    ...
                    sheetC.write(rowCounter,columnCounter+2,numOnmogelijkQuestionsAlternativesLower_loc[counter],style=easyxf(style_specialAttention))
                else:
                    # test of uppergroep een fout antwoord minder ommogelijk aanduidt dan goed antwoord
                    if (numOnmogelijkQuestionsAlternativesUpper_loc[counter] < numOnmogelijkQuestionsAlternativesUpper_loc[(question-1)*len(alternatives_loc)+alternatives_loc.index(correctAnswer)] ):
                        sheetC.write(rowCounter,columnCounter,numOnmogelijkQuestionsAlternativesUpper_loc[counter],style=easyxf(style_specialAttention))
        ...
        for alternative in alternatives_loc:
            if alternative == correctAnswer:
                ...
                if (numMogelijkQuestionsAlternativesUpper_loc[counter] < numMogelijkQuestionsAlternativesLower_loc[counter]):
                    ...
                    sheetC.write(rowCounter,columnCounter+2,numMogelijkQuestionsAlternativesLower_loc[counter],style=easyxf(style_correctAnswer+style_specialAttention))
                else:
                    ...
                    sheetC.write(rowCounter,columnCounter+2,numMogelijkQuestionsAlternativesLower_loc[counter],style=easyxf(style_correctAnswer))                
            else:
                # test of uppergroep een fout antwoord meer mogelijk aanduidt dan lower groep
                if (numMogelijkQuestionsAlternativesUpper_loc[counter] > numMogelijkQuestionsAlternativesLower_loc[counter]):
                    ...
                    sheetC.write(rowCounter,columnCounter+2,numMogelijkQuestionsAlternativesLower_loc[counter],style=easyxf(style_specialAttention))
                else:
                    # test of uppergroep een fout antwoord meer mogelijk aanduidt dan goed antwoord
                    if (numMogelijkQuestionsAlternativesUpper_loc[counter] > numMogelijkQuestionsAlternativesUpper_loc[(question-1)*len(alternatives_loc)+alternatives_loc.index(correctAnswer)] ):
                        sheetC.write(rowCounter,columnCounter,numMogelijkQuestionsAlternativesUpper_loc[counter],style=easyxf(style_specialAttention))
